...
{
    public class ClientPreferredContactMedium : IAuditEntityBase
    {
        ...
        [EnumDataType(typeof(PreferredContactMedium))]
        [Display(Name = "Medio de contacto")]
        public PreferredContactMedium PreferredContactMedium { get; set; }
        /// <summary>
        /// Bool property represent if the ClientPreferredContactMedium was deleted
        /// </summary>
