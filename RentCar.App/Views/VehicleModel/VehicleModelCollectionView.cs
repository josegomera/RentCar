...
namespace RentCar.App.Views.VehicleModelCollectionView{
    public partial class VehicleModelCollectionView : XtraUserControl {
        public VehicleModelCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<RentCar.App.ViewModels.VehicleModelCollectionViewModel>();
