...
namespace RentCar.App.Views.VehicleCollectionView{
    public partial class VehicleCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<RentCar.App.ViewModels.VehicleCollectionViewModel>();
