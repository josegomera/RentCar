...
namespace RentCar.App.Views.InspectionView{
    public partial class InspectionView : XtraUserControl {
		...
		void InitBindings() {
		    var fluentAPI = mvvmContext.OfType<RentCar.App.ViewModels.InspectionViewModel>();
			fluentAPI.WithEvent(this, "Load").EventToCommand(x => x.OnLoaded());
            fluentAPI.SetObjectDataSourceBinding(
                inspectionViewBindingSource, x => x.Entity, x => x.Update());
