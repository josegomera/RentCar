        ...
        public IEntitiesViewModel<FuelType> LookUpFuelTypes {
            get {
                return GetLookUpEntitiesViewModel(
                    ...
                    projection: query => query.Where(fuelType => !fuelType.IsDisabled));
            }
        }
        /// <summary>
        ...
        public IEntitiesViewModel<VehicleModel> LookUpVehicleModels {
            get {
                return GetLookUpEntitiesViewModel(
                    ...
                    projection: query => query.Where(model => !model.IsDisabled));
            }
        }
        /// <summary>
        ...
        public IEntitiesViewModel<VehicleType> LookUpVehicleTypes {
            get {
                return GetLookUpEntitiesViewModel(
                    ...
                    projection: query => query.Where(type => !type.IsDisabled));
            }
        }
