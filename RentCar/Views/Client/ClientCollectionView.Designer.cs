namespace RentCar.Views.ClientCollectionView {
    partial class ClientCollectionView {
		...
		private void InitializeComponent() {
			...
			this.gridControl.DataSource = clientCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(RentCar.DataModel.Entities.Client),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(RentCar.ViewModels.ClientCollectionViewModel);
			// 
            // layoutControl
            // 
