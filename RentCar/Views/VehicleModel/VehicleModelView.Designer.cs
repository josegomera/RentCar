namespace RentCar.Views.VehicleModelView {
    partial class VehicleModelView {
		...
		private void InitializeComponent() {
			...
			this.VehicleBrandBindingSource = new System.Windows.Forms.BindingSource(this.components);
			...
			this.vehicleModelViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.vehicleModelViewBindingSource.DataSource = typeof(RentCar.DataModel.Entities.VehicleModel);
			this.dataLayoutControl1.DataSource = vehicleModelViewBindingSource;
			//
			//Create GridControls
			//
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters VehicleBrandVehiclesChildPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            VehicleBrandVehiclesChildPopulateColumnParameters.FieldName = "VehicleBrandVehicles";
            VehicleBrandVehiclesChildPopulateColumnParameters.Path = "VehicleBrand.Description";
			VehiclesPopulateColumnsParameters.CustomColumnParameters.Add(VehicleBrandVehiclesChildPopulateColumnParameters);
			...
			this.VehicleBrandLookUpEdit.DataBindings.Add("EditValue", vehicleModelViewBindingSource, "VehicleBrandId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			DevExpress.XtraDataLayout.RetrieveFieldParameters VehicleBrandLookUpEditRetrieveFieldParameters = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
            VehicleBrandLookUpEditRetrieveFieldParameters.FieldName = "VehicleBrandId";
            VehicleBrandLookUpEditRetrieveFieldParameters.ControlForField = this.VehicleBrandLookUpEdit;
			parameters.CustomListParameters.Add(VehicleBrandLookUpEditRetrieveFieldParameters);
			DevExpress.XtraDataLayout.RetrieveFieldParameters VehicleBrandLookUpEditRetrieveFieldParameters_NotGenerate = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
		    VehicleBrandLookUpEditRetrieveFieldParameters_NotGenerate.FieldName = "VehicleBrand";
		    VehicleBrandLookUpEditRetrieveFieldParameters_NotGenerate.GenerateField = false;
			parameters.CustomListParameters.Add(VehicleBrandLookUpEditRetrieveFieldParameters_NotGenerate);
            ...
            this.mvvmContext.ViewModelType = typeof(RentCar.ViewModels.VehicleModelViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "VehicleModel - Element View";
