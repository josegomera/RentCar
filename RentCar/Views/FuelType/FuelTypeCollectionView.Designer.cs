namespace RentCar.Views.FuelTypeCollectionView {
    partial class FuelTypeCollectionView {
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "FuelType";
			// 
            // gridControl
            // 
			...
			this.fuelTypeCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.fuelTypeCollectionViewBindingSource.DataSource = typeof(RentCar.DataModel.Entities.FuelType);
			this.gridControl.DataSource = fuelTypeCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(RentCar.DataModel.Entities.FuelType),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(RentCar.ViewModels.FuelTypeCollectionViewModel);
			// 
            // layoutControl
            // 
