namespace RentCar.Views.EmployeeCollectionView {
    partial class EmployeeCollectionView {
		...
		private void InitializeComponent() {
			...
			this.employeeCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.employeeCollectionViewBindingSource.DataSource = typeof(RentCar.DataModel.Entities.Employee);
			this.gridControl.DataSource = employeeCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(RentCar.DataModel.Entities.Employee),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(RentCar.ViewModels.EmployeeCollectionViewModel);
			// 
            // layoutControl
            // 
		...
		private System.Windows.Forms.BindingSource employeeCollectionViewBindingSource;
