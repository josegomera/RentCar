namespace RentCar.Views.RentCollectionView {
    partial class RentCollectionView {
		...
		private void InitializeComponent() {
			...
			this.rentCollectionViewBindingSource.DataSource = typeof(RentCar.DataModel.Entities.Rent);
            ...
            ClientPopulateColumnParameters.Path = "Client.Name";
            ...
            ClientPopulateColumnParameters_NotGenerate.FieldName = "ClientId";
			...
			//Employee
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters EmployeePopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            EmployeePopulateColumnParameters.FieldName = "Employee";
            EmployeePopulateColumnParameters.Path = "Employee.Name";
			parameters.CustomColumnParameters.Add(EmployeePopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters EmployeePopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            EmployeePopulateColumnParameters_NotGenerate.FieldName = "EmployeeId";
		    EmployeePopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(EmployeePopulateColumnParameters_NotGenerate);
									//
			//Vehicle
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters VehiclePopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            VehiclePopulateColumnParameters.FieldName = "Vehicle";
            VehiclePopulateColumnParameters.Path = "Vehicle.Description";
			parameters.CustomColumnParameters.Add(VehiclePopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters VehiclePopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            VehiclePopulateColumnParameters_NotGenerate.FieldName = "VehicleId";
		    VehiclePopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(VehiclePopulateColumnParameters_NotGenerate);
										
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters NumberOfDaysPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            NumberOfDaysPopulateColumnParameters_NotVisible.FieldName = "NumberOfDays";
		    NumberOfDaysPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(NumberOfDaysPopulateColumnParameters_NotVisible);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters VehiclePopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            VehiclePopulateColumnParameters_NotVisible.FieldName = "Vehicle";
		    VehiclePopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(VehiclePopulateColumnParameters_NotVisible);
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters EmployeePopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            EmployeePopulateColumnParameters_NotVisible.FieldName = "Employee";
		    EmployeePopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(EmployeePopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(RentCar.DataModel.Entities.Rent),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(RentCar.ViewModels.RentCollectionViewModel);
			// 
            // layoutControl
            // 
