namespace RentCar.Views.RentView {
    partial class RentView {
		...
		private void InitializeComponent() {
			...
			this.rentViewBindingSource.DataSource = typeof(RentCar.DataModel.Entities.Rent);
			...
			this.ClientLookUpEdit.DataBindings.Add("EditValue", rentViewBindingSource, "ClientId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			this.EmployeeLookUpEdit.DataBindings.Add("EditValue", rentViewBindingSource, "EmployeeId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			this.VehicleLookUpEdit.DataBindings.Add("EditValue", rentViewBindingSource, "VehicleId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(RentCar.ViewModels.RentViewModel);
			// 
            // labelControl
            // 
