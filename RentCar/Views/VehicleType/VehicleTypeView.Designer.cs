namespace RentCar.Views.VehicleTypeView {
    partial class VehicleTypeView {
		...
		private void InitializeComponent() {
			...
			this.vehicleTypeViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.vehicleTypeViewBindingSource.DataSource = typeof(RentCar.DataModel.Entities.VehicleType);
			this.dataLayoutControl1.DataSource = vehicleTypeViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(RentCar.ViewModels.VehicleTypeViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "VehicleType - Element View";
