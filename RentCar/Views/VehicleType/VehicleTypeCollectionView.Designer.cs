namespace RentCar.Views.VehicleTypeCollectionView {
    partial class VehicleTypeCollectionView {
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "VehicleType";
			// 
            // gridControl
            // 
			...
			this.vehicleTypeCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.vehicleTypeCollectionViewBindingSource.DataSource = typeof(RentCar.DataModel.Entities.VehicleType);
			this.gridControl.DataSource = vehicleTypeCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(RentCar.DataModel.Entities.VehicleType),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(RentCar.ViewModels.VehicleTypeCollectionViewModel);
			// 
            // layoutControl
            // 
